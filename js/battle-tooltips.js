...
var accuracy=this.getMoveAccuracy(move,value,foeActive[0]||null);
...
if(minRatio>=3)min=150;else
if(minRatio>=2)min=110;else
if(minRatio>=1)min=70;else
min=30;

if(maxRatio>=3)max=150;else
if(maxRatio>=2)max=110;else
if(maxRatio>=1)max=70;else
max=40;
