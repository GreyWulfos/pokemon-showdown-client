...
class BattleMoveSearch extends BattleTypedSearch<'move'> {
	...
	static readonly GOOD_WEAK_MOVES = [
		'accelerock', 'acrobatics', 'aerialace', 'aquajet', 'avalanche', 'baddybad', 'barrage', 'bonemerang', 'bouncybubble', 'bulletpunch', 'buzzybuzz', 'circlethrow', 'clearsmog', 'doubleironbash', 'dragondarts', 'dragontail', 'endeavor', 'facade', 'firefang', 'flipturn', 'freezyfrost', 'freezedry', 'frustration', 'geargrind', 'glitzyglow', 'grassknot', 'gyroball', 'hex', 'icefang', 'iceshard', 'iciclespear', 'knockoff', 'lowkick', 'machpunch', 'nightshade', 'nuzzle', 'pikapapow', 'psychocut', 'pursuit', 'quickattack', 'rapidspin',  'razorleaf', 'return', 'rockblast', 'sappyseed', 'scorchingsands', 'seismictoss', 'shadowclaw', 'shadowsneak', 'sizzlyslide', 'sparklyswirl', 'storedpower', 'stormthrow', 'suckerpunch', 'superfang', 'surgingstrikes', 'tailslap',  'thundershock', 'tripleaxel', 'uturn', 'veeveevolley', 'voltswitch', 'watershuriken', 'weatherball',
	] as ID[] as readonly ID[];
